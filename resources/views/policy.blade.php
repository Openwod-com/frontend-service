...
<div id="wrap">
    ...
    <li>
    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to {{ config('app.name') }}.</p>
    ...
    <li><strong>Website</strong> refers to {{ config('app.name') }}, accessible from {{ config('app.url') }}</li> <li><strong>Service</strong> refers to the Website.</li>
    ...
    <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close your web browser. Learn more about cookies here: <a target="_blank" href="https://www.freeprivacypolicy.com/blog/cookies/">Cookies: What Do They Do?</a></p>
    ...
    <ul>
    <li>By email: mathias@rmsit.se</li>
    </ul> </div>
    </div>
    </div>
    </div>
